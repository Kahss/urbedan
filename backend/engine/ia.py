...
- **Pioche** : c'est la seule decision reellement informee du duel. L'IA ne connait de
  ...
  couleur, resout chacune contre les caracteristiques des deux Combattants engages, et
  retient la pioche dont l'esperance est la meilleure (+1 bataille gagnee, -1 perdue,
  0 nulle). Les egalites sont tranchees au hasard pour eviter un jeu previsible.
"""
import random
...
def _esperance_pioche(verso, cartes_en_pioche, caracs_soi, caracs_adv, role_soi):
...
def choisir_pioche(sommets, cartes_en_pioche, caracs_soi, caracs_adv, role_soi):
