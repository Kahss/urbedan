...
- Cartes Champ de bataille : c'est le terrain commun sur lequel se résout chaque duel. Une carte comporte 3 cases, une par Zone : **Bitume**, **Hauteur**, **Souterrain**. Chaque case porte une valeur comprise entre -2 et 6, et éventuellement un point d'Energie.
  - Le dos de la carte comporte lui aussi 3 cases, mais colorées : vert si la valeur au recto est positive, gris si elle est nulle, rouge si elle est négative. Ainsi un champ de bataille [2 et 1 Energie, 3, -2] a pour dos [vert, vert, rouge]. Ce dos donne une première information sur le terrain sans en révéler la valeur exacte, et ne dit rien de l'Energie.
...
- Cartes Combattant : ce sont les membres de chaque équipe. Chaque Combattant possède les caractéristiques suivantes :
  - Nom
  - Puissance
  - Avantage : la liste des Zones (1 à 3 Zones parmi les 3) dont le Combattant tire parti. Il ajoute à sa Puissance la valeur des cases correspondantes du champ de bataille et en récolte l'Energie ; il ignore totalement les autres cases. Un Combattant à 3 Zones encaisse toute la carte, en bien comme en mal ; un Combattant à 1 Zone est un spécialiste, qu'on n'engage que lorsque le dos annonce la bonne couleur.
  - Dégâts
  - Pouvoir
...
1. La carte Champ de bataille de la manche est piochée et posée **face cachée** : les deux joueurs découvrent son dos, c'est-à-dire la couleur des 3 Zones, et rien d'autre. Ni les valeurs exactes, ni la présence d'Energie ne sont connues à ce stade.
...
5. Chaque Combattant encaisse la valeur et l'Energie des seules cases couvertes par son Avantage. Le champ de bataille est commun, mais les deux Combattants n'en lisent pas les mêmes cases.
6. En commençant par J1, les joueurs appliquent leurs pouvoirs si les conditions sont satisfaites (nombre d'énergie et condition de jeu)
