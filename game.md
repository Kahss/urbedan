...
- Cartes Puissance : ce sont les cartes qui vont permettre de booster les combattants au cours de chaque duel, piochées en "stop ou encore" (voir "Structure d'une partie"). Chaque Carte Puissance a deux propriétés : une Puissance (entre 0 et 2) et un coût en Vie (entre 0 et 2). Ce coût en Vie n'est pas payé par le joueur qui pioche la carte : c'est le vainqueur du duel qui perd autant de Vie que la somme des coûts en Vie des cartes piochées par son adversaire (version testée). Le tas, remélangé à chaque duel, est réparti comme suit :
  - 4 cartes Destin : 2 Puissance / 0 coût en Vie
  - 9 cartes Épreuve : 1 Puissance / 1 coût en Vie
  - 6 cartes Péripétie : 0 Puissance / 0 coût en Vie
  - 1 carte Adversité : 0 Puissance / 2 coût en Vie
- Cartes Combattant : ce sont les membres de chaque équipe. Chaque Combattant possède les caractéristiques suivantes :
  - Nom
  - Puissance
  - Dégâts
  - Niveau (de 1 à 3, 3 étant le plus puissant)
  - Pouvoir
...
- Chaque joueur récupère son équipe de 4 combattants et les dispose sur la table faces visibles.
  ...
  - Dans tous les cas, l'équipe de 4 combattants doit respecter un budget : la somme de leurs 4 Niveaux ne peut pas dépasser 8.
- Chaque joueur initie ses PV à 20
...
3. Une fois les deux Combattants choisis, ils sont révélés face à face et la phase de pioche "stop ou encore" commence : mélangez un tas de 20 Cartes Puissance (4 Destin, 9 Épreuve, 6 Péripétie, 1 Adversité)
4. À tour de rôle, en commençant par J1 et jusqu'à ce que les deux joueurs se soient arrêtés, chaque joueur pioche une Carte Puissance dans ce tas, ou choisit de s'arrêter :
   - Un joueur peut choisir de s'arrêter à tout moment, ou continuer à piocher sans limite
   - Un joueur qui s'est arrêté ne peut plus piocher de nouvelle carte pour la suite du duel
5. Une fois les deux joueurs arrêtés, les cartes Puissance sont révélées, puis les joueurs appliquent leurs pouvoirs si les conditions sont satisfaites
6. La Puissance totale de chaque Combattant est définie par sa Puissance de base à laquelle s'ajoute la somme des Puissances de ses cartes piochées, le tout modifié par les Pouvoirs activés des deux combattants
...
8. Le ou les Combattants vainqueurs perdent autant de Vie que la somme des coûts en Vie des cartes piochées par leur adversaire ce duel-ci (le perdant ne perd aucune Vie pour ses propres cartes piochées)
