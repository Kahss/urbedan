...
- Cartes Bataille : c'est par elles que se résout chaque duel. Le deck compte 15 cartes distinctes et forme une **pioche unique, commune aux deux joueurs et persistante pour toute la partie** : elle n'est remélangée que lorsqu'elle est épuisée et qu'il faut encore piocher (jamais systématiquement entre deux duels).
  - La carte porte une condition qui désigne le vainqueur de la bataille à partir des caractéristiques des deux Combattants engagés (par exemple « Force la plus haute », « Dextérité + Sagesse la plus haute », « Total des trois caractéristiques le plus haut »). Aucune information n'est disponible avant qu'une carte ne soit révélée : la pioche se fait entièrement à l'aveugle, sans choix possible.
  - Composition du deck : pour chacune des trois caractéristiques, 3 cartes « la plus haute » et 1 carte « somme avec la caractéristique suivante », soit 12 cartes ; s'y ajoutent 3 cartes génériques, grises, qui lisent les trois caractéristiques :
  ...
  - Chaque caractéristique porte 4 cartes (rouge/vert/bleu), et 3 cartes sont grises : un compteur à l'écran affiche, pour chaque couleur, combien de cartes sont déjà sorties depuis le dernier remélange.
- Cartes Combattant : ce sont les membres de chaque équipe. Chaque Combattant possède les caractéristiques suivantes :
  - Nom
  - **Force** (rouge), **Dextérité** (vert) et **Sagesse** (bleu) : trois valeurs comprises entre 0 et 7, avec lesquelles il dispute les batailles. Le total des trois est compensé par les Dégâts et par la puissance de la Capacité : un Combattant qui gagne souvent, ou qui dispose d'une Capacité forte, frappe moins fort. En pratique, le roster se tient entre 8 et 10 de total — en dessous, un Combattant perd trop souvent pour que ses Dégâts (plafonnés à 5) puissent compenser, à moins que sa Capacité ne soit justement pensée pour un profil qui ne cherche pas à gagner ses duels. Une valeur extrême est plus utile qu'une valeur moyenne : un 5 remporte les cartes « la plus haute » de sa couleur, un 0 remporte celles « la plus basse », et un 7 pousse cette logique plus loin encore — mais une caractéristique extrême est aussi ce qu'une Capacité adverse peut annuler le plus durement.
  - Dégâts
...
- Le deck de 15 cartes Bataille est commun aux deux joueurs et posé face cachée au centre de la table pour toute la partie ; il n'est remélangé que lorsqu'il est épuisé
...
4. Les batailles se résolvent alors automatiquement, une par une, sans aucun choix des joueurs :
   - la carte du dessus de la pioche unique est révélée ; si la pioche est épuisée, elle est d'abord remélangée
   - sa condition est immédiatement résolue à partir des caractéristiques des deux Combattants engagés, et la carte est attribuée au joueur dont le Combattant l'emporte
...
7. Les cartes du duel (batailles remportées et batailles nulles) restent défaussées : la pioche continue sur sa lancée pour le duel suivant, sans être remélangée (sauf si elle vient à s'épuiser).
